    ...
    <footer className="bg-[#1A1A1A] px-6 sm:px-12 md:px-16 text-white pt-12 pb-4">
      <div className="container mx-auto flex flex-col lg:flex-row items-start lg:items-stretch justify-between gap-8">
        ...
        <div className="w-full lg:w-1/3 h-full flex flex-col justify-between">
          ...
          <p className="text-[12px] sm:text-xl">I am a web developer and SEO expert studying DATA SCIENCE, exploring the intersection of data and technology through cloud-applied generative AI engineering. My journey is about mastering the latest AI tools to enhance web development and the science of data.</p>
        </div>
